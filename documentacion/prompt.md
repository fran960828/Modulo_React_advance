...
- Explicación e instalación paso a paso de una app de react con typescript junto con vitest y react testing library.
- Explicación y uso de render y screen.
- Explicación y uso de get, query y find partiendo de screen, cada uno agrupa varias funciones y se emplean con objetivos distintos.
- Explicación y uso de userEvent.
- Explicación y uso de react testing hooks
