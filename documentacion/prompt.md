...
- Explicación de las principales configuración que se pueden emplear en cypress.config.js.
- Explicación de los diferentes timeouts.
- Explicación de la diferencia entre configuración global en el archivo config y local en el describe de una test suite especifica.
- Explicación de como configurar un navegador u otro.
- Explicación de baseUrl
- Explicación de la creación y uso de custom commands
- Explicación de la creación y uso de custom queries
- Explicación y uso de task desde el cypress.config.js usando on y llamado dicha tarea con cy.task en nuestros test.
